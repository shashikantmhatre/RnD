...
public class AssignmentLocalEvaluator implements Evaluator {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(AssignmentLocalEvaluator.class);
	
	public AssignmentLocalEvaluator(Context context,
	...
	public Object evaluate() {
		if (logger.isInfoEnabled()) {
			logger.info("evaluate the AssignmentLocalEvaluator by calling AssignmentEvaluator");
		}
