...
@Entity
@Table(name = "SIM_DomainTableEntry")
@XmlRootElement(name = "DomainTableEntry")
public class DomainTableEntry implements Serializable {
...
//	@GeneratedValue
	...
	@Column(name="MINIMUMVALUE", columnDefinition="DOUBLE PRECISION")
	@XmlElement(name = "MinValue")
	private Double minValue;
	
	@Column(name="MAXIMUMVALUE", columnDefinition="DOUBLE PRECISION")
	@XmlElement(name = "MaxValue")
	private Double maxValue;
	
	public DomainTableEntry(){
	...
	public void setDomainTable(DomainTable domainTableID) {
		this.domainTable = domainTableID;
	}
	...
	public boolean equals(Object entry) {
		...
		if(entry instanceof DomainTableEntry){
			if(this.id.equals(((DomainTableEntry) entry).getId())){
				return true;
			}
		}
