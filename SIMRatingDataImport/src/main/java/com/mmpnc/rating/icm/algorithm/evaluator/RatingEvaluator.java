...
public class RatingEvaluator implements AlgorithmEvaluator {
	private Context context;
	private List<AlgorithmEvaluator> keyValues;
	
	public RatingEvaluator(List<AlgorithmEvaluator> keyValues) {
	...
	public Object evaluate() {
		...
		for(String process : variables.split(",")){
			...
			buffer.append("Execute (XPATH:\"").append(parentXpath).append("/").append(process.trim()) .append("\")").append(AlgoConstant.NewLine);
		}
