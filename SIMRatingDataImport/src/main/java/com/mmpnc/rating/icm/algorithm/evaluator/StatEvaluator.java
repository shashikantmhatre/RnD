...
public class StatEvaluator implements AlgorithmEvaluator {
	private Context context;
	private List<AlgorithmEvaluator> keyValues;
	
	public StatEvaluator(List<AlgorithmEvaluator> keyValues) {
	...
	public Object evaluate() {
		...
		for(String process : variables.split(",")){
			...
			buffer.append("Stat (XPATH:\"").append(parentXpath).append("/").append(process.trim()) .append("\")").append(AlgoConstant.NewLine);
		}
