...
public class FormAttachEvaluator implements AlgorithmEvaluator {
	private Context context;
	private List<AlgorithmEvaluator> keyValues;
	
	public FormAttachEvaluator(List<AlgorithmEvaluator> keyValues) {
	...
	public Object evaluate() {
		...
		for(String process : variables.split(",")){
			...
			buffer.append("Attach (XPATH:\"").append(parentXpath).append("/").append(process.trim()) .append("\")").append(AlgoConstant.NewLine);
		}
